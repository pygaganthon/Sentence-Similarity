...
df=pd.read_csv('C:/Users/maitr/OneDrive/Desktop/NLP_Project_4Dec//data/dev-set.txt', sep="\t",error_bad_lines=False)

df.dropna(axis=0, how='any', thresh=None, subset=None, inplace=True)

#df=pd.read_csv('C:/Users/gagan/OneDrive/Desktop/NLPProject/data/sample_train.txt', sep="\t",error_bad_lines=False)
df_features=pd.read_csv('C:/Users/maitr/OneDrive/Desktop/NLP_Project_4Dec//df_features_dev//df_features_devtxtt.txt', sep="\t",error_bad_lines=False)
...
df_model_f=df_model_f.drop(['id', 'Sentence1', 'Sentence2','Token_Sentence1',
       ...
       'PosTagLema_Sentence1', 'PosTagLema_Sentence2','Common_Hyper_Score','Common_prepositions','ALl_EdgePath_Dep_Wt_by_lch','EdgePath_Dep_Wt_by_lch'],axis=1)
...
def Majority_vote(X_train,X_test,y_train,y_test,ylabels):
    import pickle
#    from sklearn.model_selection import train_test_split
...
predicted_labels,Accuracy_mvoted=Majority_vote(X_train,X_test,y_train,y_test,ylabels)
...
data_test.to_csv('dev-set.txt',sep='\t',index=None)
